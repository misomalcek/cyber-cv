/**
 * Live counts from the hive's own stores, captured 2026-08-19.
 *
...
export const capturedAt = '2026-08-19';

export const qdrant = [
  { name: 'sessions',     points: 11371 },
  { name: 'project ctx',  points: 5802 },
  { name: 'knowledge',    points: 5132 },
  { name: 'planning',     points: 3448 },
  { name: 'code',         points: 3086 },
  { name: 'docs',         points: 1166 },
  { name: 'memory',       points: 1118 },
] as const;

export const qdrantTotal = qdrant.reduce((n, c) => n + c.points, 0); // 31,123

export const graphs = {
  knowledge: { entities: 1040, relationships: 5419 },
  code:      { entities: 3086, relationships: 10209 },
  docs:      { entities: 637 },
  plan:      { nodes: 982, edges: 584, projects: 14 },
} as const;
